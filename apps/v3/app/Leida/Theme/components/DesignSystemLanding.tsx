...
import { Eyebrow } from '@leida/design-system/components/brand/Eyebrow';
import { Logo } from '@leida/design-system/components/brand/Logo';
import { Button } from '@leida/design-system/components/forms/Button';
import { Input } from '@leida/design-system/components/forms/Input';
import { Badge } from '@leida/design-system/components/feedback/Badge';
import { Tag } from '@leida/design-system/components/feedback/Tag';
import { Accordion } from '@leida/design-system/components/feedback/Accordion';
import { Card } from '@leida/design-system/components/surfaces/Card';
import { TopBar } from '@leida/design-system/components/navigation/TopBar';
            ...
            <Box sx={{ display: 'grid', gap: 1.5 }}>
              ...
              <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(3, 1fr)' }, gap: 1.5 }}>
                ...
                <Card variant="tile" padding="sm">
                  ...
                  <p style={{ margin: '8px 0 0' }}>Generate routine content with Leida voice.</p>
                </Card>
                <Card variant="tile" padding="sm">
              ...
              <Accordion
                items={[
                  ...
                  },
                  {
                    ...
                    a: 'Yes. Leida is currently hard-overridden to this route and can be switched back easily.',
                  },
                ]}
              />
            </Box>
