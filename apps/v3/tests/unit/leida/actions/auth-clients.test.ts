import { set as setAuth } from '@/app/Leida/Auth/actions/set';
import { fetchClients } from '@/app/Leida/Clients/actions/fetchClients';
import initClients from '@/app/Leida/Clients/actions/init';
import { emailClient } from '@/app/Leida/Clients/actions/emailClient';
...
describe('Leida Auth and Clients actions', () => {
  beforeEach(() => {
    jest.clearAllMocks();
